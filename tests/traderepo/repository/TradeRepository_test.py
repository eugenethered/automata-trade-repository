...
class TradeRepositoryTestCase(unittest.TestCase):
    ...
    def test_should_store_and_retrieve_trade(self):
        trade = InstrumentTrade(instrument_from='OTC', instrument_to='GBP', quantity=BigFloat('100.00'), price=BigFloat('1.01'), value=BigFloat('101'), status=Status.SUBMITTED, order_id='88888888', instant=1)
